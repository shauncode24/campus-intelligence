  ...
  return (
    <div
      className={`message-wrapper ${
        m.role === "user" ? "message-wrapper-you" : "message-wrapper-ai"
      }`}
    >
      <div
        className={`message-container ${
          m.role === "user" ? "message-container-you" : "message-container-ai"
        }`}
      >
        <b
        ...
        <div className="message-content">
          <div
            className={`message-bubble ${
              m.role === "user" ? "bubble-you" : "bubble-ai"
            }`}
          >
            <div
              className={`message-header ${
                m.role === "user" ? "header-you" : "header-ai"
              }`}
            >
            ...
            {!isStreaming && (
              <div
                className={`message-footer ${
                  m.role === "user" ? "footer-you" : "footer-ai"
                }`}
              >
